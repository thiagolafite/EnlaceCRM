...
exports.ALL_MESSAGE_TEMPLATES = void 0;
exports.seedAllTemplates = seedAllTemplates;
...
async function seedAllTemplates() {
    ...
    for (const tpl of exports.ALL_MESSAGE_TEMPLATES) {
        let dateId = null;
    ...
    console.log(`✅ ${exports.ALL_MESSAGE_TEMPLATES.length} templates cadastrados com sucesso (WhatsApp & E-mail)!`);
}
